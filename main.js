...
var randomnumber=Math.floor((Math.random()*quick_draw_data_set.length)+1);
var sketch=quick_draw_data_set[randomnumber];
...
function updateCanvas() {
    background("white");
    randommnumber = Math.floor((Math.random()  * quick_draw_data_set.length) + 1);
